...
def generate_fake_uav_dataset(
    ...
    目标: 固定敌机 0 的每步相对位移 delta (dx, dy, dz)
    """
    ...
    root.attrs["description"] = "3v3 UAV Combat Enemy0 Delta-Position Data"
    ...
    print(f"delta 最大绝对值: {max_abs_delta}")
    print(f"绘图换算比例: 1.0 单位 = {meters_per_unit:.1f} 米")


if __name__ == "__main__":
    MY_SAVE_PATH = "/home/dfc/Documents/zdy_documents/diffusion_policy/uav_task_bundle/data/uav_combat/test_data.zarr"
    MY_NUM_EPISODES = 20
    MY_EPISODE_LEN = 600
