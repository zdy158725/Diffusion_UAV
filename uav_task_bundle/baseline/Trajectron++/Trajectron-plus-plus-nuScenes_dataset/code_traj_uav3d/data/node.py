...
except ImportError:  # pragma: no cover - optional dependency for bicycle-specific helpers
    Quaternion = None
...
def _require_quaternion():
    if Quaternion is None:
        raise ImportError("pyquaternion is required for heading-aware bicycle utilities.")
